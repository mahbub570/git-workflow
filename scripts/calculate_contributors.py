#!/usr/bin/env python3
"""
Script: Calculate Top Contributors for Scribe Community Spotlight
Purpose: Fetches commit and pull request data from GitHub for Scribe projects over the past 30 days
         (25th of last month to 25th of current month), calculates top non-organization contributors,
         and formats a message with PR links for the Matrix channel.
Usage: Run via GitHub Actions workflow. Requires GITHUB_TOKEN environment variable.
"""
...
# Configuration
ORG = "scribe-org"  # GitHub organization name
TOP_N = 5  # Number of top contributors to display
...
if __name__ == "__main__":
    main()
    # TODO: Add retry logic for API rate limits or network failures